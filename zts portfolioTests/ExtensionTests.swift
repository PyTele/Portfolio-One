...
//  zts portfolioTests
//
//  Created by Hubert Leszkiewicz on 28/09/2021.
//
...
class ExtensionTests: XCTestCase {
    func testSequenceKeyPathSortingSelf() {
        ...
        XCTAssertEqual(sortedItems, [1, 4, 3, 2, 5], "The sorted numbers must be ascending.")
    }
    ...
    func testBindingOnChange() {
        ...
        // Then
        XCTAssertTrue(onChangeFunctionRun, "The onChange() function must be run when this binding is changed.")
    }
}
